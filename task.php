...
?>
<h1 class="text-center fw-bolder">Lista de Tarefas</h1>
                    ...
                    <table class="table table-sm table-bordered table-hover table-striped">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Adicionada em</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        <a class="btn btn-sm btn-outline-dark rounded-0 view_data" href="./?page=view_task&id=<?= $row['task_id'] ?>" data-id='<?= $row['task_id'] ?>' title="Tarefa"><span class="material-symbols-outlined">subject</span></a>
                                        <?php if($_SESSION['type'] == 1): ?>
